...
Instagram.prototype.generate_post_data = function(options) {
...
Instagram.prototype.generate_subscriptions_options = function(content_length) {
  return {
...
Instagram.prototype.subscribe = function(location, callback) {
...
Instagram.prototype.search_media = function(location, count, callback) {
...
Instagram.prototype.fetch_new_geo_media = function(object_id, count, callback) {
...
Instagram.prototype.subscriptions = function(callback) {
  var req = https.request({
    hostname: 'api.instagram.com',
...
Instagram.prototype.delete_subscription = function(id, callback) {
...
Instagram.prototype.delete_all_subscription = function(callback) {
  var request = https.request({
    hostname: 'api.instagram.com',
